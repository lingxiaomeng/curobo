...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.inverse_kinematics
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.inverse_kinematics --visualize
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.inverse_kinematics --differential
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.inverse_kinematics --reachability

To try reachability with a dual-arm robot:

.. code-block:: bash

   python -m curobo_floating_base.examples.getting_started.inverse_kinematics --reachability --robot dual_ur10e.yml
...
from curobo_floating_base.scene import Cuboid, Scene
from curobo_floating_base.types import ContentPath, GoalToolPose, Pose
