...
:class:`~curobo_floating_base.Mapper` API fuses depth frames into a compact world model and
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.volumetric_mapping --root ./datasets/sun3d/sun3d-mit_76_studyroom-76-1studyroom2
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.volumetric_mapping --root ./datasets/sun3d/sun3d-mit_76_studyroom-76-1studyroom2 --visualize
...
When the tutorial finishes successfully you will see::
    ...
    Saved renders to: ~/.cache/curobo_floating_base/examples/volumetric_mapping

    Computing ESDF...
    Extracting mesh...
    Saved mesh: output_mesh.ply (150,000 vertices)

The following files are written to ``~/.cache/curobo_floating_base/examples/volumetric_mapping/``
(override with ``curobo_floating_base._src.runtime.cache_dir``):
...
from curobo_floating_base import runtime
from curobo_floating_base.content import get_assets_path
...
from curobo_floating_base.scene import Cuboid, Mesh, SceneData
from curobo_floating_base.types import CameraObservation, DeviceCfg, Pose
