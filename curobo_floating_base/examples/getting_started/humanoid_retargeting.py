...
cuRobo :class:`~curobo_floating_base.motion_retargeter.MotionRetargeter` API. All solver
...
The :class:`~curobo_floating_base.motion_retargeter.MotionRetargeter` API encapsulates this
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.build_robot_model \\
     --urdf curobo_floating_base/content/assets/robot/g1/g1_29dof_rev_1_0.urdf \\
     --asset-path curobo_floating_base/content/assets/robot/g1 \\
     --tool-frames \\
       pelvis torso_link \\
     ...
     --output curobo_floating_base/content/configs/robot/unitree_g1_29dof_retarget.yml \\
     --visualize
...
``curobo_floating_base/content/configs/robot/unitree_g1_29dof_retarget.yml``.


Step 4: Three Levels of Retargeting
-------------------------------------

:class:`~curobo_floating_base.motion_retargeter.MotionRetargeter` is the high-level API that
...
weights via :class:`~curobo_floating_base._src.cost.tool_pose_criteria.ToolPoseCriteria`, passed
...
.. code-block:: python
    ...
    from curobo_floating_base.motion_retargeter import (
        MotionRetargeter,
        MotionRetargeterCfg,
...
.. code-block:: bash
    ...
    python -m curobo_floating_base.examples.getting_started.humanoid_retargeting \\
...
:class:`~curobo_floating_base._src.motion.motion_retargeter_cfg.MotionRetargeterCfg`.
...
from curobo_floating_base.scene import Sphere
from curobo_floating_base.types import DeviceCfg, JointState, Pose
...
def visualize_motion(
    ...
    """
    from curobo_floating_base.types import ContentPath, JointState as JS
    from curobo_floating_base.viewer import ViserVisualizer
...
def export_motion_to_usd(
    ...
    """
    from curobo_floating_base.viewer import UsdWriter
