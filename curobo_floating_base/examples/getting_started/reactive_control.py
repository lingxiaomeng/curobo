...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.reactive_control

To try MPC with a humanoid robot:

.. code-block:: bash

   python -m curobo_floating_base.examples.getting_started.reactive_control --visualize --robot unitree_g1.yml
...
When the tutorial finishes successfully you will see::
    ...
    Trajectory plot saved to: ~/.cache/curobo_floating_base/examples/reactive_control/reactive_control.pdf
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.reactive_control --visualize
