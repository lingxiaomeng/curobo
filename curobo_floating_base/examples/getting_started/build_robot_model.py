...
:class:`~curobo_floating_base.robot_builder.RobotBuilder` API generates both and writes them
...
cuRobo ships robot URDFs under ``curobo_floating_base/content/assets/robot/``, so the
...
.. code-block:: bash
   ...
   python -m curobo_floating_base.examples.getting_started.build_robot_model \\
       --urdf curobo_floating_base/content/assets/robot/franka_description/franka_panda.urdf \\
       --asset-path curobo_floating_base/content/assets/robot/franka_description \\
...
is ready to use with :mod:`~curobo_floating_base.wrap.reacher.ik_solver`,
:mod:`~curobo_floating_base.wrap.reacher.motion_gen`, or any other cuRobo wrapper.
...
from curobo_floating_base.logging import setup_logger
from curobo_floating_base.robot_builder import RobotBuilder
