...
Output files are written to ``~/.cache/curobo_floating_base/examples/custom_optimization/``
by default. Override with ``curobo_floating_base.runtime.cache_dir``.
"""
...
from curobo_floating_base.optim import (
    MPPI,
    EvolutionStrategies,
...
from curobo_floating_base.rollout import RosenbrockCfg, RosenbrockRollout
from curobo_floating_base.types import DeviceCfg
