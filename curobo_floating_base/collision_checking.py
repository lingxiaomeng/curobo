...
Example:
    ```python
    from curobo_floating_base.collision_checking import RobotCollisionChecker, RobotCollisionCheckerCfg
    from curobo_floating_base.scene import Scene
    import torch
...
from curobo_floating_base._src.collision.collision_robot_scene import (
    RobotSceneCollision as RobotCollisionChecker,
)
from curobo_floating_base._src.collision.collision_robot_scene_cfg import (
