...
# CuRobo
from curobo_floating_base._src.solver.solver_core_cfg import create_scene_collision_cfg
...
class TestSolverCfgCreateSceneCollisionCfg:
    ...
    def test_create_scene_collision_cfg_with_scene(self, cuda_device_cfg):
        ...
        from curobo_floating_base._src.util_file import get_scene_configs_path
