...
class TestConvertXrdfToCurobo:
    ...
    def test_convert_xrdf_to_curobo_basic(
        ...
        with patch(
            "curobo_floating_base._src.util.xrdf_util.UrdfRobotParser", return_value=mock_kinematics_parser
        ):
...
class TestXrdfRoundTripWithRealConfig:
    ...
    def test_load_franka_config(self):
        ...
        # CuRobo
        from curobo_floating_base._src.util.config_io import load_yaml
    ...
    def test_convert_franka_to_xrdf(self):
        ...
        with patch("curobo_floating_base._src.util.xrdf_util.load_yaml", return_value=mock_spheres):
