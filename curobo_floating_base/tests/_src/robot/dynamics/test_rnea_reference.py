...
from curobo_floating_base.tests._src.robot.dynamics.rnea_numpy_reference import (
    FIXED,
    Y_ROT,
...
class TestWithCuroboRobot:
    """Test RNEA using a real robot loaded through curobo_floating_base."""
...
class TestRNEABackwardFiniteDiff:
    ...
    def _finite_diff_check(self, data, q, qd, qdd, tau_bar, eps=1e-6):
        ...
        from curobo_floating_base.tests._src.robot.dynamics.rnea_numpy_reference import rnea, rnea_backward
