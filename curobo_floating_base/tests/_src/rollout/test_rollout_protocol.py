...
from curobo_floating_base._src.rollout.rollout_rosenbrock import RosenbrockCfg, RosenbrockRollout
...
class TestReExports:
    ...
    def test_rollout_result_reexport(self):
        from curobo_floating_base._src.rollout.rollout_protocol import RolloutResult as RR
        assert RR is RolloutResult

    def test_rollout_metrics_reexport(self):
        from curobo_floating_base._src.rollout.rollout_protocol import RolloutMetrics as RM
        assert RM is RolloutMetrics

    def test_costs_and_constraints_reexport(self):
        from curobo_floating_base._src.rollout.rollout_protocol import CostsAndConstraints as CC
        assert CC is CostsAndConstraints

    def test_cost_collection_reexport(self):
        from curobo_floating_base._src.rollout.rollout_protocol import CostCollection as CC
