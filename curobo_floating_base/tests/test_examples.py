...
EXAMPLES = [
    "curobo_floating_base.examples.getting_started.forward_kinematics",
    "curobo_floating_base.examples.getting_started.inverse_kinematics",
    "curobo_floating_base.examples.getting_started.motion_planning",
    "curobo_floating_base.examples.getting_started.reactive_control",
    "curobo_floating_base.examples.getting_started.build_robot_model",
]
