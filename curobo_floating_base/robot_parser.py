...
:class:`curobo_floating_base.kinematics.Kinematics`. Most users do not call parsers directly — the
high-level builders in :mod:`curobo_floating_base.robot_builder` consume them internally. This module
