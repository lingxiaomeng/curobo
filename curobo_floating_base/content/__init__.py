...
def list_available_robots() -> List[str]:
    ...
    Example:
        >>> from curobo_floating_base.content import list_available_robots
...
def get_robot_path(robot_name: str) -> Path:
    ...
    Example:
        >>> from curobo_floating_base.content import get_robot_path
        >>> franka_path = get_robot_path('franka')
        >>> print(franka_path)
        /path/to/curobo_floating_base/content/assets/robot/franka
    """
