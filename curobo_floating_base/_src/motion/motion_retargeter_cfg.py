...
"""Configuration for :class:`~curobo_floating_base._src.motion.motion_retargeter.MotionRetargeter`."""
...
class MotionRetargeterCfg:
    ...
    #: Dict of link name to :class:`~curobo_floating_base._src.cost.tool_pose_criteria.ToolPoseCriteria`.
