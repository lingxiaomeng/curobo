...
from curobo_floating_base._src.geom.collision import SceneCollision
from curobo_floating_base._src.rollout.goal_registry import GoalRegistry
from curobo_floating_base._src.rollout.metrics import RolloutMetrics
from curobo_floating_base._src.rollout.rollout_robot import RobotRollout
from curobo_floating_base._src.solver.solve_mode import SolveMode
from curobo_floating_base._src.solver.solve_state import SolveState
from curobo_floating_base._src.solver.solver_core import SolverCore
from curobo_floating_base._src.solver.solver_trajopt_cfg import TrajOptSolverCfg
from curobo_floating_base._src.solver.solver_trajopt_result import TrajOptSolverResult
...
from curobo_floating_base._src.types.tool_pose import GoalToolPose, ToolPose
from curobo_floating_base._src.util.cuda_event_timer import CudaEventTimer
from curobo_floating_base._src.util.logging import log_and_raise, log_info, log_warn
from curobo_floating_base._src.util.torch_util import get_torch_jit_decorator, is_cuda_graph_reset_available
from curobo_floating_base._src.util.trajectory import calculate_dt_no_clamp, get_batch_interpolated_trajectory
from curobo_floating_base._src.util.trajectory_seed_generator import TrajectorySeedGenerator
...
class TrajOptSolver:
    ...
    def solve_pose(
        ...
        if needs_pad:
            from curobo_floating_base._src.solver.solver_ik import _pad_batch_inputs
        ...
        if needs_pad:
            from curobo_floating_base._src.solver.solver_ik import _slice_batch_result
