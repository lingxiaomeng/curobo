...
import curobo_floating_base._src.runtime as runtime
from curobo_floating_base._src.runtime import cuda_core_backend as enable_cuda_core_runtime
...
def _try_load_cuda_core_backend() -> Optional[dict]:
    ...
    try:
        from curobo_floating_base._src.curobolib.backends.cuda_core_backend import (
            dynamics as cc_dyn,
        )
        from curobo_floating_base._src.curobolib.backends.cuda_core_backend import (
            geometry as cc_geo,
...
def _try_load_pybind_backend() -> Optional[dict]:
    ...
    try:
        from curobo_floating_base._src.curobolib.backends.pybind import (
            geometry as _geo,
        )
        from curobo_floating_base._src.curobolib.backends.pybind import (
            kinematics as _kin,
...
class _BackendProxy:
    ...
    ``from curobo_floating_base._src.curobolib.backends import kinematics as kinematics_cu``
...
def __getattr__(name: str) -> Any:
    ...
    returned proxy, so ``from curobo_floating_base._src.curobolib.backends import X`` does
