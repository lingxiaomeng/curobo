...
class CuroboRuntime:
    ...
    def get_cuda_core_cache(self):
        ...
        if self._cuda_core_cache is None:
            from curobo_floating_base._src.curobolib.backends.cuda_core_backend import CudaCoreKernelCache
    ...
    def get_warp_cache(self):
        ...
        if self._warp_cache is None:
            # Future: from curobo_floating_base.curobolib.backends.warp_backend import WarpKernelCache
