...
from curobo_floating_base._src.util_file import get_assets_path, get_robot_configs_path, join_path, load_yaml
...
class KinematicsLoaderCfg:
    ...
    #: asset_root_path or use :class:`~curobo_floating_base.util.file_path.ContentPath`.
    use_external_assets: bool = False

    #: Deprecated path to load assets from external module. Use
    #: :class:`~curobo_floating_base.util.file_path.ContentPath` instead.
