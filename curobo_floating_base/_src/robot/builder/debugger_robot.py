...
from curobo_floating_base._src.util.xrdf_util import convert_xrdf_to_curobo
from curobo_floating_base._src.util_file import load_yaml
...
class RobotDebugger:
    ...
    Example:
        Load from cuRobo YAML::
            ...
            >>> from curobo_floating_base._src.robot.builder.debugger_robot import RobotDebugger
            >>>
            >>> # Load robot config
