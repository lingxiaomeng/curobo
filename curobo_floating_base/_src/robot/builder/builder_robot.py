...
from curobo_floating_base._src.geom.sphere_fit import SphereFitType, fit_spheres_to_mesh
from curobo_floating_base._src.geom.sphere_fit.types import SphereFitMetrics
...
from curobo_floating_base._src.util.sampling.sample_buffer import SampleBuffer
from curobo_floating_base._src.util.viser_visualizer import ViserVisualizer
from curobo_floating_base._src.util.xrdf_util import convert_curobo_to_xrdf
from curobo_floating_base._src.util_file import join_path, load_yaml, write_yaml
from curobo_floating_base.content import get_assets_path, get_robot_configs_path
...
class RobotBuilder:
    ...
    Example:
        Creating new robot model::
            ...
            >>> from curobo_floating_base._src.robot.builder.builder_robot import RobotBuilder
            >>>
            >>> # Create builder
