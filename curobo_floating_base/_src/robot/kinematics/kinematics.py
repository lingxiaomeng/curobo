...
from curobo_floating_base._src.geom.types import Mesh, Sphere
...
from curobo_floating_base._src.state.state_joint_ops import augment_joint_state
from curobo_floating_base._src.types.pose import Pose
from curobo_floating_base._src.types.tool_pose import ToolPose
    ...
    def get_robot_as_spheres(
        ...
        for j in range(sph_all.shape[0]):
            ...
            if filter_valid:
                sph_list = [
                    Sphere(
                        name="curobo_floating_base/robot_sphere_" + str(i),
