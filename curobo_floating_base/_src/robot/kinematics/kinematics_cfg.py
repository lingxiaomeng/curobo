...
from curobo_floating_base._src.robot.parser.parser_base import RobotParser
...
from curobo_floating_base._src.robot.types.self_collision_params import SelfCollisionKinematicsCfg
from curobo_floating_base._src.types.content_path import ContentPath
from curobo_floating_base._src.types.device_cfg import DeviceCfg
from curobo_floating_base._src.util.config_io import is_file_xrdf
...
class KinematicsCfg:
    ...
    :ref:`curobo_floating_base.util.xrdf_utils.convert_xrdf_to_curobo`.
    """
    ...
    #: :class:`~curobo_floating_base.cuda_robot_model.cuda_robot_generator.KinematicsLoader`.
    ...
    #: :func:`~curobo_floating_base.cuda_robot_model.cuda_robot_generator.KinematicsLoader._build_collision_model`.
    ...
    #: :class:`~curobo_floating_base.cuda_robot_model.kinematics_parser.RobotParser`.
    ...
    def from_data_dict(
        ...
        """Load robot from a dictionary containing data for :class:`~curobo_floating_base.cuda_robot_model.cuda_robot_generator.KinematicsLoaderCfg`.
