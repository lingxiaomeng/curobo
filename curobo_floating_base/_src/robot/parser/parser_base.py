...
# Third Party
from curobo_floating_base._src.geom.types import Mesh, Obstacle
...
class RobotParser:
    ...
    def build_link_parent(self):
        ...
        :meth:`curobo_floating_base._src.robot.parser.parser_urdf.UrdfRobotParser.build_link_parent`
