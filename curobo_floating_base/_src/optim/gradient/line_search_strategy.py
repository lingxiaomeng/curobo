...
used by :class:`~curobo_floating_base.optim.gradient.line_search_opt.LineSearchOpt` to optimize alongside methods
to calculate the step direction.

cuRobo implements several line search strategies, including:

1. Greedy line search
   (:class:`~curobo_floating_base.optim.gradient.line_search_strategy.GreedyLineSearchStrategy`)
2. Armijo line search
   (:class:`~curobo_floating_base.optim.gradient.line_search_strategy.ArmijoLineSearchStrategy`)
3. Wolfe line search (:class:`~curobo_floating_base.optim.gradient.line_search_strategy.WolfeLineSearchStrategy`)
4. Strong Wolfe line search
   (:class:`~curobo_floating_base.optim.gradient.line_search_strategy.StrongWolfeLineSearchStrategy`)
5. Approximate Wolfe line search
   (:class:`~curobo_floating_base.optim.gradient.line_search_strategy.ApproxWolfeLineSearchStrategy`)
...
# CuRobo
from curobo_floating_base._src.curobolib.cuda_ops.optimization import wolfe_line_search

# Third Party
from curobo_floating_base._src.optim.gradient.line_search_context import LineSearchContext
from curobo_floating_base._src.optim.gradient.line_search_result import LineSearchResult
from curobo_floating_base._src.optim.gradient.line_search_state import LineSearchState
from curobo_floating_base._src.optim.gradient.update_best_solution import update_best_solution
from curobo_floating_base._src.optim.optimization_iteration_state import OptimizationIterationState
from curobo_floating_base._src.util.logging import log_and_raise, log_info
