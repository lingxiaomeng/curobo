...
if TYPE_CHECKING:
    from curobo_floating_base._src.cost.cost_support_polygon_cfg import CostSupportPolygonCfg

from curobo_floating_base._src.cost.cost_base import BaseCost
from curobo_floating_base._src.geom.convex_polygon_helper import ConvexPolygon2DHelper
