...
from curobo_floating_base._src.types.tensor import (
    T_BHDOF_float,
    T_BHValue_bool,
    T_BHValue_float,
    T_BValue_bool,
...
from curobo_floating_base._src.util.helpers import list_idx_if_not_none
from curobo_floating_base._src.util.logging import log_and_raise
from curobo_floating_base._src.util.tensor_util import cat_sum
...
class RolloutResult(Sequence):
    ...
    algorithms (e.g., :class:`curobo_floating_base.opt.opt_base.OptBase`) to minimize costs while satisfying
