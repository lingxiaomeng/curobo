...
from curobo_floating_base._src.collision.collision_robot_scene_cfg import RobotSceneCollisionCfg
...
class RobotSceneCollision(RobotSceneCollisionCfg):
    ...
    Example:
        ```python
        from curobo_floating_base._src.collision import RobotSceneCollision, RobotSceneCollisionCfg
