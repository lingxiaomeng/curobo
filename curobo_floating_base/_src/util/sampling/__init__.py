...
Examples:
    ...
    >>> from curobo_floating_base.util.sampling import SampleBuffer, HaltonSequencer, RobertsSequencer
    ...
    >>> from curobo_floating_base.util.sampling import create_halton_sample_lib
    >>> sample_lib = create_halton_sample_lib(sample_config, horizon=50, action_dim=7)
    >>> samples = sample_lib.get_samples([1000])

    Custom composition:
    >>> from curobo_floating_base.util.sampling import SampleBuffer, RandomSequencer, StandardPostProcessor
