...
Example:
    ```python
    from curobo_floating_base import ModelPredictiveControl, ModelPredictiveControlCfg
    from curobo_floating_base.types import JointState, Pose
...
from curobo_floating_base._src.solver.solver_mpc import MPCSolver as ModelPredictiveControl
from curobo_floating_base._src.solver.solver_mpc_cfg import MPCSolverCfg as ModelPredictiveControlCfg
from curobo_floating_base._src.solver.solver_mpc_result import (
