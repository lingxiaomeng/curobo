...
def main():
    ...
    # Add a fixed sphere obstacle to the scene and collision world.
    sphere_pose = [0.45, -0.2, 0.35, 1.0, 0.0, 0.0, 0.0]
    sphere.VisualSphere(
        "/World/obstacle_sphere_0",
        position=np.array(sphere_pose[:3]),
        orientation=np.array(sphere_pose[3:]),
        radius=0.12,
